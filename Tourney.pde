class Tourney {
  ...
  String generateTourneyName() {
    ...
    switch(r) {
      case 1:
        return tourneyNoun + " Open";
      case 2:
        return tourneyNoun + " Cup";
      case 3:
        return tourneyNoun + " Challenge";
      case 4:
        return tourneyNoun + " Invitational";
      case 5:
        return tourneyNoun + " Tour";
      case 6:
        return tourneyNoun + " Tournament";
      case 7:
        return "The Player's " + tourneyNoun;
      case 8:
        return "The Hole " + tourneyNoun;
      default:
        return "Undefined";
    }   
  }
